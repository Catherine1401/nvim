...
-- 				return { desc = "dotnet: " .. desc, silent = true }
-- 			end
--
-- 			map("n", "<leader>db", function()
-- 				dotnet.build_solution()
-- 			end, o("Build solution"))
-- 			map("n", "<leader>dB", function()
-- 				dotnet.build_solution_quickfix()
-- 			end, o("Build solution (quickfix)"))
...
-- 				dotnet.outdated()
-- 			end, o("Outdated packages"))
-- 			map("n", "<leader>da", function()
-- 				dotnet.add_package()
-- 			end, o("Add NuGet package"))
